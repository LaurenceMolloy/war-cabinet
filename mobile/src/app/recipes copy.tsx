                ...
                <View style={{marginTop: 15, paddingTop: 15, borderTopWidth: 1, borderTopColor: '#334155'}}>
                  ...
                  <View style={{flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 10}}>
                    {sessionCustomExp.sort().map(item => (
                      <View key={item} testID={`fridge-addon-chip-${item.toLowerCase().replace(/\s+/g, '-')}`} style={[styles.allergenChip, styles.stockChipActive, { flexDirection: 'row', alignItems: 'center' }]}>
              ...
              <View style={{marginTop: 16, marginBottom: 24}}>
                  ...
                  <View style={{flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 12}}>
                    {selectedStaples.sort().map(s => (
                       <View key={s} testID={`fridge-staple-chip-${s.toLowerCase().replace(/\s+/g, '-')}`} style={[styles.allergenChip, styles.stockChipActive, { flexDirection: 'row', alignItems: 'center' }]}>
